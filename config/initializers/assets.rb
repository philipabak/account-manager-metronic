...
Rails.application.config.assets.precompile += %w( application.css components.css dataTables.bootstrap.css dataTables.scroller.min.css default.css font-awesome.min.css layout.css login-soft.css plugins.css select2.css uniform.default.css datepicker3.css datetimepicker.css )
Rails.application.config.assets.precompile += %w( bootstrap.min.js dataTables.bootstrap.js dataTables.tableTools.min.js jquery.backstretch.min.js jquery.dataTables.min.js jquery.uniform.min.js jquery.validate.min.js jquery-1.11.0.min.js layout.js login-soft.js metronic.js quick-sidebar.js table-advanced.js bootstrap-datepicker.js components-pickers.js bootstrap-datetimepicker.min.js )
